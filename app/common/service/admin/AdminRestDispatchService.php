...
/** 将 /api/v1/admin/* 分发到已注册 handler */
final class AdminRestDispatchService
{
    ...
    public function dispatch(?string $path = null): Response
    {
        ...
        if ($relative === '') {
            $relative = $this->adminRestRouteRegistry->relativePathFromRequest((string) Request::pathinfo());
        }

        $registry = $this->adminRestRouteRegistry;
