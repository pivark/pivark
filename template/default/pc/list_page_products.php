...
<html lang="zh-CN">
    ...
    <body class="pv-portal-site pv-channel-product pv-product-hub-page">
        ...
        <!-- 区块：产品中心（左：检索筛选网格 · 右：分类/热门/咨询） -->
        <main aria-label="产品中心" class="pv-channel-main pv-portal-main pv-product-hub">
            <div class="container">
                <div class="row g-3 g-lg-4">
                    <div class="col-lg-9 d-flex flex-column gap-3">
                        ...
                        <div class="card shadow-sm pv-product-filter-board" aria-label="产品筛选">
                            <div class="card-body">
                                <div class="pv-product-filter-board__head d-flex flex-wrap align-items-start justify-content-between gap-2 mb-3">
                                    <div class="pv-product-filter-board__head-start">
                                        <span class="card-title h6 mb-1 pv-product-filter-board__title">参数筛选</span>
                                        <div class="pv-product-filter-board__hint small text-muted">
                                            {pv:if value="0" name="page_content_empty"}
                                                {$page_content|raw}
                                            {pv:else}
                                                <p class="mb-0">浏览在售型号，按分类、输出信号与精度等级筛选检索。</p>
                                            {/pv:if}
                                        </div>
                                    </div>
                                    <button type="button" class="btn btn-link btn-sm p-0 d-none" id="pv-product-filter-reset">清除筛选</button>
                                </div>
                                <div class="pv-product-filters" id="pv-product-filters" aria-live="polite"></div>
                            </div>
                        </div>

                        <div class="pv-product-list pv-product-list--catalog row g-3 g-md-4" id="pv-product-list" data-limit="12" aria-live="polite">
                            {pv:arclist entity="product" row="12"}
                            ...
                            <div class="card shadow-sm pv-side-block">
                                <div class="card-body">
                                    ...
                                    <ul class="pv-side-list pv-side-list--thumb">
                                        {pv:arclist entity="product" row="5" orderby="new" indexpad="2"}
                                        <li>
                                            <a href="{$field.url}">
