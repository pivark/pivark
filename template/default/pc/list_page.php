...
<html lang="zh-CN">
    ...
    <body class="pv-portal-site pv-site-page">
        ...
        <!-- 区块：通用单页正文（page_content） -->
        <main aria-label="单页正文" class="pv-channel-main">
            <div class="container container-narrow">
                {pv:if value="0" name="page_content_empty"}
                    <div class="pv-content pv-article-content pv-legal-body">{$page_content|raw}</div>
                {/pv:if}
            </div>
        </main>
