...
<html lang="zh-CN">
    ...
    <!-- pv:template label="应用案例详情" hint="图集优先 · {pv:doc_gallery_groups} + 介绍正文" scope="document" -->
    <body class="pv-portal-site pv-doc-detail pv-channel-cases pv-doc-gallery-detail">
