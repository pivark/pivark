...
<html lang="zh-CN">
    ...
    <!-- pv:template label="资料下载详情" hint="下载中心条目 · 先介绍正文 · 再附件下载" scope="document" -->
    <body class="pv-portal-site pv-doc-detail pv-channel-download pv-doc-download-detail">
        ...
        <!-- 区块：资料详情（先介绍正文，再附件下载） -->
        <main aria-label="资料下载详情" class="pv-channel-main pv-portal-main pv-download-hub">
            <div class="container">
                <div class="row g-3 g-lg-4">
                    <article class="col-lg-9">
                        <div class="pv-doc-article-panel pv-download-detail-panel">
                            <header class="article-header mb-4">
                                <div class="article-header__title-row">
                                    <div class="article-header__main">
                                        <p class="small text-muted mb-2"><i class="bi bi-file-earmark-arrow-down" aria-hidden="true"></i> {$page_title}</p>
                                        <h1 class="article-main-title h3">{$document_title}</h1>
                            ...
                            <!-- 正文之后再给附件下载：先阅读介绍，再取文件 -->
                            <section class="pv-download-detail-files mt-4 mb-2" id="pv-doc-downloads" aria-label="资料附件下载">
                                <header class="pv-doc-section-head">
                                    <h2 class="pv-doc-section-title"><i class="bi bi-cloud-download" aria-hidden="true"></i> 下载本资料</h2>
                                    <p class="pv-doc-section-desc text-muted small mb-0">阅读完介绍后，可在此下载完整文件。</p>
                                </header>
                            ...
                            {pv:if name="document_has_doc_vod"}
                                <!-- 区块：文档视频 -->
                                <section class="pv-doc-video mt-4" id="pv-doc-video" aria-label="文档视频">
                                    <header class="pv-doc-section-head">
                                        <h2 class="pv-doc-section-title"><i class="bi bi-play-btn" aria-hidden="true"></i> 视频</h2>
                                    </header>
                            ...
                            <!-- 区块：文档侧栏（相关推荐 · 标签） -->
                            <aside class="col-lg-3" aria-label="资料侧栏">
                                <div class="sidebar">
